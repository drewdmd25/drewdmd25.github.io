(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.db, 200, 286);
        collectable.create(type.max, 200, 600);
        collectable.create(type.steve, 5, 600);
        collectable.create(type.grace, 800, 215);
        collectable.create(type.kennedi, 720, 10, 10, 8);
